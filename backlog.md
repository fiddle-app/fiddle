...
| P4  | P1  | .x  | Research bundling strategy (no bundler vs esbuild)                                                                                                                 | [research/bundling-strategy.md](research/bundling-strategy.md)                           |
...
| C17 | P1  | .   | Build `tags-to-skeleton.js` — reads ctags `tags` file + source JSDoc, outputs grouped Markdown skeleton                                                            | See [architecture.md §9](architecture.md#codebase-skeleton-generation)                   |
